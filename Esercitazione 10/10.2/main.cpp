...
// DICHIARAZIONE DELLE VARIABILI GLOBALI
 ...
 const int G_migr = 20; //ogni quante generazioni migrare
...
int main (int argc, char *argv[]){
   ...
   // OSS: per come ho strutturato i dati mi è necessario tenere il record di pos_sent
  ...
  // ALLOCAZIONE DINAMICA DELLE VARIABILI
	 ...
	 ofstream output("besties" + to_string(rank) + ".txt");
