...
//variabili per g(r_i)
int* ig; // indici
double bin_size; // larghezza di ogni bin
double sd; // estremo destro della binnatura
int nbins; // numero di bin
double* bin; // estremo sinistro di ogni bin
double* dV; // elemento di volume per normalizzazione
